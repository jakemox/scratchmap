<footer>
  <nav>
    <a href="/"><img src="\img/europe.svg" alt="homepage" height="40px" width="40px"></a>
    ...
    @endauth
    @guest
    <a href="/register"><img src="/img/padlock-light.svg" alt="register" height="40px" width="40px"></a>
