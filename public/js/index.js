...
var City = function (_React$Component) {
  ...
  _createClass(City, [{
    ...
    value: function componentDidMount() {
      fetch('https://maps.googleapis.com/maps/api/place/textsearch/json?query=prague+attraction&type=point_of_interest&language=en&key=' + "AIzaSyA4MbB1Q-xRwV1jc7Zo87g4d4aaK9XrWOg").then(function (response) {
...
/* unused harmony default export */ var _unused_webpack_default_export = (City);
